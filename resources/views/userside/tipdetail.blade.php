...
@if($fetch->image!="null")
<meta property="og:image" content="http://digitalkidszone.com/tipimages/{{$fetch->image}}" />
@endif
<meta property="og:url" content="http://digitalkidszone.com/tipdetail/{{$ptitle}}/{{$fetch->id}}" />
                ...
                <div class="breadcrumbs-wrap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Learning Tip Detail page</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="row">
                ...
                <div class="article_detail_wrapss single_article_wrap format-standard">
                    <div class="article_body_wrap">
                        ...
                        <div class="article_featured_image">
                           ...
                           @else
                      <img class="img-fluid" src="/tipimages/{{$fetch->image}}" alt="">
                        ...
                        <div class="article_top_info">
                            <ul class="article_middle_info">
                                ...
                                ?>
                                @if($cat)
                                <li><a href="#"><span class="icons"><i class="ti-user"></i></span>{{$cat->category_name}}</a></li>
                              @endif
                            </ul>
                        </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    ...
                    <ul>
                        ...
                        <li>
                            <span class="left">
                                ...
                                @elseif($f->image!="null")
                                <a href="/tipdetail/{{$f->Title}}/{{$f->id}}"> <img src="/tipimages/{{$f->image}}" style="width: 70px;height: 50px;" class="img-fluid" alt="portfolio1">
                                </a>
                                @endif
                               
                            </span>
                            <span class="right">
                                <a class="feed-title" href="/tipdetail/{{$f->Title}}/{{$f->id}}">{{$f->Title}}</a> 
                                <?php
                                $cat = DB::table('allcategorytbls')->where('id',$fetch->type)->first();
                                ?>
                                @if($cat)
                ...
                <span class="mr-3" style="font-size:20px">Share this post</span>
                      <?php
               $url = urlencode("http://digitalkidszone.com/tipdetail/$ptitle/$fetch->id");?>
