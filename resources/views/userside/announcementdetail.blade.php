...
@if($fetch->image!="null")
<meta property="og:image" content="http://digitalkidszone.com/annimages/{{$fetch->image}}" />
@endif
<meta property="og:url" content="http://digitalkidszone.com/announcementdetail/{{$ptitle}}/{{$fetch->id}}" />
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="breadcrumbs-wrap">
                    <h1 class="breadcrumb-title">Announcement</h1>
        ...
        <div class="row">
                ...
                <div class="article_detail_wrapss single_article_wrap format-standard">
                    <div class="article_body_wrap">
                        ...
                        <div class="article_featured_image">
                            ...
                            @else
                            <a href="/announcementdetail/{{$fetch->headline}}/{{$fetch->id}}">  <img class="img-fluid" src="/annimages/{{$fetch->image}}" alt="">
                            </a>
                            @endif
                        ...
                        <div class="article_top_info">
                            <ul class="article_middle_info">
                                <li><a href="#"><span class="icons"><i class="ti-user"></i></span>{{$fetch->a_date}}</a></li>
                                <?php
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                ...
                <div class="single_widgets widget_thumb_post">
                    <h4 class="title">Related Announcement</h4>
                    <ul>
                        @if(count($fetchall))
                        ...
                        <li>
                            <span class="left">
                                ...
                                @elseif($f->image!="null")
                                <a href="/announcementdetail/{{$f->headline}}/{{$f->id}}"> <img src="/annimages/{{$f->image}}" style="width: 70px;height: 50px;" class="img-fluid" alt="announcement">
                                </a>
                                @endif
                               
                            </span>
                            <span class="right">
                                <a class="feed-title" href="/announcementdetail/{{$f->headline}}/{{$f->id}}">{{$f->headline}}</a> 
                                <span class="post-date"><i class="ti-calendar"></i>{{$f->a_date}}</span>
                            </span>
                        </li>
                        @endforeach
                        @else
                ...
                <span class="mr-3" style="font-size:20px">Share this post</span>
                      <?php
               $url = urlencode("http://digitalkidszone.com/announcementdetail/$ptitle/$fetch->id");?>
