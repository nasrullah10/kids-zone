...
<form action="{{URL::to('/adminupdatestory/'.$update->id)}}" enctype="multipart/form-data" method="post">
    @csrf
        ...
        <input class="form-control" required placeholder="Enter title" rows="3" name="updatestorytitle" value="{{ $update->Title}}">
        <br>
