...
<form action="{{URL::to('/adminstorycreatepost')}}" enctype="multipart/form-data" method="post">
    @csrf

        <label style="font-weight: bold;">Category:</label>
        <select name="insertstorytype" required class="form-control" id="">
        ...
        <input class="form-control" required placeholder="Enter Title" rows="3" name="insertstorytitle">
        <br>
        ...
        <a href="/adminstory" class="btn btn-secondary">Back to List</a>
</form>
