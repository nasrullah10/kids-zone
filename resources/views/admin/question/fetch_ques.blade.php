...
@section("title")
Admin | Fetch-Question
@endsection
@section("content")
<br>
<h1>Questions</h1><a href="/quescreateget" class="btn btn-info">Create New</a>
<br><br>
...
<table class="table table-responsive">
  ...
  <tbody>
   ...
   <tr>
    ...
    <td>{{ $fq->marks }}</td>
    <td><a href="/queseditget/{{$fq->id}}" class="btn btn-success text-white">Edit</a>
    <a href="/quesdelete/{{$fq->id}}" class="btn btn-danger text-white">Delete</a></td>
   </tr>
   @endforeach
