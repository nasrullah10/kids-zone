...
@section("title")
Admin | Round 1 Stories
@endsection
@section("content")

<br><br>
<h2 style="color:teal">Round 1 Stories</h2>
<br>
<p>
...
<table class="table table-responsive">
  ...
  <tbody>
   ...
   <td>{{ $fs->video_url }}</td>
    ...
    @if($fs->status ==0)
    <td><a href="/approveround1story/{{$fs->id}}" class="btn btn-outline-info">Approve..</a>
    <a href="/rejectround1story/{{$fs->id}}" class="btn btn-outline-danger">Reject..</a></td>
    @elseif($fs->status==1)
