...
<form action="{{URL::to('/updateround1story/'.$update->id)}}" enctype="multipart/form-data" method="post">
    @csrf


    <label style="font-weight: bold;">Round:</label>
    <input class="form-control" readonly value="{{$firstround->round}}" rows="3" name="round1">
        <br>
